        ...
        <div class="container-fluid bg-dark px-0">
            <div class="row gx-0">
                ...
                <div  id="admin_login_menu_box">
                    ...
                    <a href="#"> <img src="resources/img/adminMenu.png" id="adminMenu" /><p id="adminMenu_letter">관리자메뉴</p> </a>
                    <a href="#"> <img src="resources/img/logout.png" id="admin_logout" /><p class="register_letter">로그아웃</p> </a>
